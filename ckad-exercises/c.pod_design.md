...
> 考点： NodeSelector or NodeAffinity
...
# if you created deployment by 'run' command(run 在后续版本中将废弃，建议直接用create)
...
###  Ex-C25
<p style="color:red"><strong>Autoscale</strong> the deployment, pods between 5 and 10, targetting CPU utilization at 80%</p>
